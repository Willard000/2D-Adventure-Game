...
function update_direction(spell)
	...
	-- direction vec
	local vec = {x = player_pos:get_x() - pos:get_x() - (pos:get_w() / 2),
		     y = player_pos:get_y() - pos:get_y() - (pos:get_h() / 2)}
...
function Eskimo_Leader_Attack.update(spell)
...
function Eskimo_Leader_Attack.cast(spell, x, y, x2, y2)
